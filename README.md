...
1. From [Download .NET for Windows](https://dotnet.microsoft.com/en-us/download)
    - Install the .NET 6.0 SDK - *required by SpreadsheetGear code samples*
    - Install the .NET 7.0 SDK - *required by tools in .NET Extension Pack for Visual Studio Code*
