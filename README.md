...
5. For Python code samples 
    - Install [Python](https://www.python.org/) (what I use for developing this repo) or a "conda" installer like [Anaconda](https://www.anaconda.com/products/distribution) or [MiniConda](https://conda.io/projects/conda/en/latest/user-guide/install/index.html) which include Python
